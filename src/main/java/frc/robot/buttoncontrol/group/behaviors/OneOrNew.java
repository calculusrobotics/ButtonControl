    ...
    public void handle(int true_ran, int true_expected, EButton lastTrueB, EButton b, EButton[] buttons) {
        ...
        // if 2 are pressed...
            ...
            if (true_ran == true_expected) {
                ...
                // if the other true button's true command was called in the last iteration, call this button
                if (lastOtherIteration == it - 1) {
                    b.requestTrue();
                // if this true button's true command was called in the last iteration, call the other button
